...
export const Header: React.FC<HeaderProps> = ({
  ...
  const pageTitles: Record<NavigationPage, { title: string; subtitle: string }> = {
    ...
    'production': { title: 'تسجيل عملية إنتاج جديدة', subtitle: 'إدخال بيانات الوردية، المكبس، وحساب الأوزان والهالك' },
    'production-entry': { title: 'تسجيل عملية إنتاج جديدة', subtitle: 'إدخال بيانات الوردية، المكبس، وحساب الأوزان والهالك' },
