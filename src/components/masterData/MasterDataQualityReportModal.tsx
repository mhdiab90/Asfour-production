...
const ENTITY_LABELS: Record<MasterDataTab, { ar: string; en: string }> = {
  ...
  tubeBallMills: { ar: 'طواحين الأنابيب والكرات', en: 'Tube & Ball Mills' },
  bunkers: { ar: 'البناكر', en: 'Bunkers' },
  rotaryKilns: { ar: 'الأفران الدوارة', en: 'Rotary Kilns' },
  jobReferences: { ar: 'أوامر الشغل', en: 'Job References' },
  batches: { ar: 'الدفعات', en: 'Batches' },
  boms: { ar: 'قوائم المواد', en: 'Bills of Materials' },
  routings: { ar: 'مسارات التصنيع', en: 'Routings' },
